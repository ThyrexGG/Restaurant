...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#f5f5f5]">
      <Helmet>
        <title>Best Khmer Restaurant | Authentic Khmer Cuisine in Phnom Penh</title>
        <meta name="description" content="Discover authentic Khmer cuisine at Best Khmer Restaurant in Phnom Penh. Browse our menu of traditional dishes and reserve your table today." />
      </Helmet>
